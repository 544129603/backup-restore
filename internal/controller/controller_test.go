...
func TestPolicyReconcileCreatesOnlyOneDeterministicTask(t *testing.T) {
	...
	scope := &protectionv1alpha1.BackupScope{ObjectMeta: metav1.ObjectMeta{Name: "scope", UID: types.UID(uuid.NewUUID())}, Spec: protectionv1alpha1.BackupScopeSpec{ResourceIdentity: protectionv1alpha1.ResourceIdentity{ClusterRef: "c1", ProjectRef: "p1"}, Mode: protectionv1alpha1.BackupScopeModeNamespace, IncludeNamespaces: []string{"app"}}, Status: protectionv1alpha1.BackupScopeStatus{CommonStatus: protectionv1alpha1.CommonStatus{Phase: protectionv1alpha1.ScopePhaseReady}}}
	repository := &protectionv1alpha1.BackupRepository{ObjectMeta: metav1.ObjectMeta{Name: "repo", UID: types.UID(uuid.NewUUID())}, Spec: protectionv1alpha1.BackupRepositorySpec{ResourceIdentity: protectionv1alpha1.ResourceIdentity{ClusterRef: "c1", ProjectRef: "_platform"}}, Status: protectionv1alpha1.BackupRepositoryStatus{CommonStatus: protectionv1alpha1.CommonStatus{Phase: protectionv1alpha1.RepositoryPhaseReady}}}
	policy := &protectionv1alpha1.BackupPolicy{ObjectMeta: metav1.ObjectMeta{Name: "hourly", UID: uid, CreationTimestamp: created}, Spec: protectionv1alpha1.BackupPolicySpec{ResourceIdentity: protectionv1alpha1.ResourceIdentity{ClusterRef: "c1", ProjectRef: "p1"}, ScopeRef: protectionv1alpha1.ObjectReference{Name: scope.Name}, RepositoryRef: protectionv1alpha1.ObjectReference{Name: repository.Name}, Schedule: protectionv1alpha1.BackupScheduleSpec{Cron: "* * * * *", Timezone: "Etc/UTC"}, Enabled: true, ConcurrencyPolicy: protectionv1alpha1.ConcurrencyForbid, MissedRunPolicy: protectionv1alpha1.MissedRunOnce, StartingDeadline: metav1.Duration{Duration: time.Hour}, MaxCatchUpRuns: 1, Timeout: metav1.Duration{Duration: time.Hour}}}
	kube := fake.NewClientBuilder().WithScheme(scheme).WithStatusSubresource(&protectionv1alpha1.BackupPolicy{}, &protectionv1alpha1.BackupScope{}, &protectionv1alpha1.BackupRepository{}, &protectionv1alpha1.BackupTask{}).WithObjects(scope, repository, policy).Build()
